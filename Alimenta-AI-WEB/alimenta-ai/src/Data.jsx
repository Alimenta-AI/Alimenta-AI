...
export async function getDadosCursos() {
  try {
    const response = await axios.get("http://localhost:8080/AlimentaAI/cursos");
...
export const cursos = [
  {
    ...
    description:
      "Curso voltado para os iniciantes no investimento, que não possui nenhuma experiência na área.",
    image: courses1,
  },
  {
    id: 2,
