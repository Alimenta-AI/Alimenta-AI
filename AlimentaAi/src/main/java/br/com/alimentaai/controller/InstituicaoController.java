...
public class InstituicaoController {
    ...
    public Instituicao recebeDadosInstituicao(String clienteId){
        Connection con= Conexao.abrirConexao();
        InstituicaoDAO instituicaoDAO = new InstituicaoDAO(con);
        Instituicao instituicao = instituicaoDAO.buscarInstituicaoPeloClienteId(clienteId);
        Conexao.fecharConexao(con);
        if(instituicao != null){
            return instituicao;
        }
    ...
    public Instituicao atualizarInstituicao(Instituicao instituicao) throws IOException {
        Connection con = Conexao.abrirConexao();
        InstituicaoDAO instituicaoDAO = new InstituicaoDAO(con);
        InstituicaoService instituicaoService = new InstituicaoService();
        ...
        String website = instituicao.getWebsite();
        String tipo = instituicao.getTipo();
        String clienteId = instituicao.getClienteId();
        int tipoCliente = instituicao.getTipoCliente();
        ...
        if (instituicaoService.validarDadosInstituicao()) {
            ...
            instituicao.setWebsite(website);
            instituicao.setTipo(tipo);
            instituicao.setClienteId(clienteId);
            instituicao.setTipoCliente(tipoCliente);

            System.out.println(instituicaoDAO.atualizar(instituicao));
        } else {
            System.out.println("Os dados do usuário não são válidos.");
            return null;
        }
    ...
    public Instituicao excluirInstituicao(Instituicao instituicao){
        Connection con = Conexao.abrirConexao();
        InstituicaoDAO instituicaoDAO = new InstituicaoDAO(con);

        String clienteId = instituicao.getClienteId();

        System.out.println(instituicaoDAO.deletar(clienteId));

        Conexao.fecharConexao(con);
        return instituicao;
    }

    public Instituicao instituicaoJsonToClass(String json) {
        Gson gson = new Gson();
